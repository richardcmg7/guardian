...
<head>
  ...
  <title>Registro - Sistema Guardian</title>
          ...
          <form class="" action="<?php echo base_url('register/doregister') ?>" method="post">
            ...
            <div class="mdl-grid">
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                <span class="mdl-card__title-text text-color--smooth-gray">Administrador guardian</span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
              ...
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                  ...
                  <label class="mdl-textfield__label" for="e-mail">Correo electrónico</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                  ...
                  <label class="mdl-textfield__label" for="password">Volver a escribir Contraseña</label>
                </div>
                ...
                <span class="login-link">Aceptos los terminos en <a href="#" class="underlined">Terminos de servicio</a></span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                <a href="<?php echo base_url('login') ?>" class="login-link">Ya me he registrado</a>
