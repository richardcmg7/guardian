                  ...
                  <form class="" action="<?php echo base_url('login/dologin')?>" method="post">
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="mdl-card__title-text text-color--smooth-gray">Administrador</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="login-name text-color--white">Iniciar sesión</span>
                            <span class="login-secondary-text text-color--smoke">Ingresa los campos para iniciar sesion</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                            <a href="<?php echo base_url('register')?>" class="login-link">No tienes cuenta?</a>
