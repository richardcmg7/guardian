...
class Main extends CI_Controller {
  ...
  public function index()
  {
		...
		// Traemos los datos de los actuadores
		if($device_data_act = $this->Main_model->get_data_act($_SESSION['selected_device'])){
			print_r($device_data_act);
			$data['data_a'] = $device_data_act->data_a;
			$data['data_b'] = $device_data_act->data_b;
			$data['data_c'] = $device_data_act->data_c;
			$data['device_sn'] = $device_data_act->data_device_sn;
		}
